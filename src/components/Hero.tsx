    ...
    <section className="relative min-h-screen flex items-center justify-center bg-slate-950 overflow-hidden">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center pt-20 pb-16">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.3 }} className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <Link href="/contact" className="inline-flex items-center px-8 py-3 text-base font-medium text-white bg-gradient-to-r from-blue-500 to-violet-500 rounded-md hover:from-blue-600 hover:to-violet-600 transition-all shadow-lg shadow-blue-500/25 hover:shadow-blue-500/40">
            Request a Demo
          </Link>
        ...
        <motion.div initial={{ opacity: 0, y: 40 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, delay: 0.5 }} className="mt-16 relative">
          <div className="relative mx-auto max-w-4xl">
            <div className="absolute -inset-4 bg-gradient-to-r from-blue-500/20 to-violet-500/20 rounded-xl blur-2xl" />
            <div className="relative bg-slate-900 border border-slate-700/50 rounded-xl overflow-hidden shadow-2xl">
              ...
              <div className="p-6 space-y-4">
                ...
                <div className="space-y-2">
                  {[
                    { name: 'Johnson, M.', amount: '$425,000', status: 'Approved', statusColor: 'bg-green-500/20 text-green-400' },
                    { name: 'Williams, R.', amount: '$312,500', status: 'Processing', statusColor: 'bg-blue-500/20 text-blue-400' },
                    { name: 'Chen, S.', amount: '$550,000', status: 'Underwriting', statusColor: 'bg-amber-500/20 text-amber-400' },
                  ].map((row) => (
                    <div key={row.name} className="flex items-center justify-between bg-slate-800/30 rounded-lg px-4 py-2.5 text-sm">
