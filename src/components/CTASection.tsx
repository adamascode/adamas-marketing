    ...
    <section className="relative py-24 bg-navy-950 overflow-hidden">
      ...
      <div className="relative z-10 max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <FadeIn>
          ...
          <Link href="/contact" className="inline-flex items-center px-8 py-3.5 text-base font-medium text-white bg-teal-600 rounded-md hover:bg-teal-500 transition-all shadow-lg shadow-teal-600/20 hover:shadow-teal-500/30">
            Request a Demo
          </Link>
        </FadeIn>
      </div>
